...
def detect_corners(image_files, calib_board, criteria,
    ...
    :param image_files: image file
    :param calib_board: calibration board file
    :param criteria: cv2.findChessboardCorners criteria
    :param sub_pix_criteria: cv2.cornerSubPix criteria
    :param sub_pix_win_size: cv2.cornerSubPix window size parameter
    :param sub_pix_zero_zone: cv2.cornerSubPix zeros zone parameter
    :param draw: draw corner detection
    :return: objpoints - list of object points for each frame
                         None if chessboard was not detected in a specific frame
             imgpoints - list of image points for each frame (in corresponding order)
                         None if chessboard was not detected in a specific frame
